...
<a href="/beneficiaires" class="nav-item active">&#128101; Beneficiaires</a>
...
<div class="main">
<div class="topbar"><div class="topbar-title">&#128101; Beneficiaires</div><a href="/dashboard" class="btn-action">&#8592; Dashboard</a></div>
<div class="content">
<?= $this->Flash->render() ?>
<div class="panel">
<div class="panel-header"><div class="panel-title">Liste des Beneficiaires</div></div>
<div class="panel-body">
<table>
<thead><tr><th>Beneficiaire</th><th>Nb Interventions</th></tr></thead>
<tbody>
<?php if(empty($beneficiaires)): ?>
<tr><td colspan="2" style="text-align:center;color:rgba(250,248,242,0.4);font-style:italic;padding:2rem">Aucun beneficiaire.</td></tr>
<?php else: foreach($beneficiaires as $b): ?>
<tr>
<td><?= h($b->beneficiaire) ?></td>
<td><span class="badge-etat etat-pend"><?= h($b->total) ?></span></td>
</tr>
