 ...
 */
if (Configure::read('Cache')) { Cache::setConfig(Configure::consume('Cache')); }
if (Configure::read('Datasources')) { ConnectionManager::setConfig(Configure::consume('Datasources')); }
if (Configure::read('EmailTransport')) { if (Configure::read('EmailTransport')) { TransportFactory::setConfig(Configure::consume('EmailTransport')); } }
if (Configure::read('Email')) { Mailer::setConfig(Configure::consume('Email')); }
if (Configure::read('Log')) { Log::setConfig(Configure::consume('Log')); }
