...
body{min-height:100vh;background:#3E1F00;display:flex;align-items:center;justify-content:center;font-family:Georgia,serif;}
.box{background:linear-gradient(135deg,rgba(150,75,0,0.15),rgba(62,31,0,0.95));border:1px solid rgba(200,150,62,0.3);border-radius:16px;padding:2.5rem;width:min(420px,90vw);}
...
.btn{width:100%;background:linear-gradient(135deg,#C8963E,#964B00);border:none;border-radius:8px;padding:0.85rem;color:#FAF8F2;font-size:0.95rem;cursor:pointer;letter-spacing:0.05em;}
.btn:hover{background:linear-gradient(135deg,#A0722A,#C8963E);}
...
<div class="box">
  <div class="logo">
    ...
    <div class="logo-sub">Ministere du Commerce et de la Consommation - MADAGASCAR</div>
  </div>
  <h2>Connexion</h2>
