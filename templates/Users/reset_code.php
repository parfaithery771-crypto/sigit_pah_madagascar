...
.btn{width:100%;background:linear-gradient(135deg,#1a5c2e,#2D8C4E,#4caf50);border:2px solid rgba(45,140,78,0.8);border-radius:8px;padding:0.85rem;color:#ffffff;font-size:0.95rem;font-weight:800;cursor:pointer;font-family:inherit;margin-bottom:1rem;box-shadow:0 4px 20px rgba(45,140,78,0.55)}
.btn:hover{opacity:0.9}font-size:0.95rem;font-weight:bold;cursor:pointer;font-family:inherit;margin-bottom:1rem;box-shadow:0 4px 15px rgba(200,150,62,0.4)}
