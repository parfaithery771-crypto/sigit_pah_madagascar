...
<div id="ov-apropos" onclick="if(event.target===this)closeOv()" style="position:fixed;inset:0;background:rgba(10,6,0,0.97);display:none;align-items:center;justify-content:center;z-index:100;backdrop-filter:blur(8px)">
  <div style="background:linear-gradient(135deg,rgba(201,168,76,0.08),rgba(10,6,0,0.97));border:1px solid rgba(200,150,62,0.25);border-radius:16px;padding:2.5rem;width:min(540px,90vw);position:relative">
    ...
    <p style="font-size:0.88rem;line-height:1.7;color:rgba(250,248,242,0.75);margin-bottom:1rem">Le <b style="color:#C8963E">SIGIT</b> (Systeme d Information de Gestion et suivi des Interventions Informatiques) est une plateforme numerique developpee pour la <b>Direction des Systemes d Information (DSI)</b> du Ministere du Commerce et de la Consommation de la Republique de Madagascar. Elle permet de centraliser, suivre et analyser toutes les interventions informatiques du parc materiel ministeriel.</p>
...
<div id="ov-aide" onclick="if(event.target===this)closeOv()" style="position:fixed;inset:0;background:rgba(10,6,0,0.97);display:none;align-items:center;justify-content:center;z-index:100;backdrop-filter:blur(8px)">
  <div style="background:linear-gradient(135deg,rgba(201,168,76,0.08),rgba(10,6,0,0.97));border:1px solid rgba(200,150,62,0.25);border-radius:16px;padding:2.5rem;width:min(480px,90vw);position:relative">
    ...
    <div class="aide-q"><div class="aq-q">&#128100; Role Administrateur</div><div class="aq-a">Acces complet : gestion des utilisateurs, validation des comptes, consultation de toutes les interventions, rapports globaux et statistiques de tous les techniciens.</div></div>
    <div class="aide-q"><div class="aq-q">&#128736; Role Technicien</div><div class="aq-a">Enregistrer ses propres interventions, consulter ses livrables, voir ses statistiques personnelles et modifier son profil et mot de passe.</div></div>
    <div class="aide-q"><div class="aq-q">Comment creer une intervention ?</div><div class="aq-a">Connectez-vous → Tableau de Bord → remplissez le formulaire (date, beneficiaire, type, travaux effectues) → cliquez Enregistrer.</div></div>
    <div class="aide-q"><div class="aq-q">Comment voir les statistiques ?</div><div class="aq-a">Menu gauche → Statistiques. L admin voit toutes les donnees, le technicien voit uniquement ses propres interventions.</div></div>
    <div class="aide-q"><div class="aq-q">Mot de passe oublie ?</div><div class="aq-a">Page de connexion → cliquez "Mot de passe oublie" → entrez votre email → un code vous est envoye automatiquement par email.</div></div>
